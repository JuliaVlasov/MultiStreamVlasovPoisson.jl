...
DocMeta.setdocmeta!(MultiPhaseVlasov, :DocTestSetup, :(using MultiPhaseVlasov); recursive = true)
...
makedocs(;
    ...
    authors = "Mehdi Badsi <mehdi.badsi@univ-nantes.fr>, Pierre Navaro <perre.navaro@math.cnrs.fr>, Nicolas Crouseilles <nicolas.crouseilles@inria.fr> ",
    repo = "https://github.com/juliavlasov/MultiPhaseVlasov.jl/blob/{commit}{path}#{line}",
    sitename = "MultiPhaseVlasov.jl",
    format = Documenter.HTML(; canonical = "https://juliavlasov.github.io/MultiPhaseVlasov.jl"),
    pages = list_pages(),
)
